import { CheckCircle, Clock, Pause, Play, X } from 'lucide-react'
...
const SessionDetailPanel = ({ isOpen, onClose, task }: SessionDetailPanelProps) => {
            ...
            <div>
              ...
              <div className="space-y-2">
                {task.sessions.map((session) => (
                  <div className="bg-gray-50 rounded-lg p-3" key={session.id}>
