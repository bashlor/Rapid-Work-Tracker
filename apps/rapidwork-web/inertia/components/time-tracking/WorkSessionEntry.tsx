...
import { Trash2, Copy, CheckCircle, AlertCircle, ChevronDown, ChevronUp } from 'lucide-react'
...
import type { BackendTaskWithRelations, BackendDomainWithSubdomains } from '@/types/backend'
import { localInputToUtcIso, formatTimeDisplay } from '@/utils/datetime'
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <Select value={formData.domainId} onValueChange={handleDomainChange}>
              ...
              <div className="space-y-3">
                ...
                {formData.useSubdomain && formData.domainId ? (
                  <Select value={formData.subdomainId || ''} onValueChange={handleSubdomainChange}>
                    <SelectTrigger className="h-11">
          ...
          {formData.domainId && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Select value={formData.taskId} onValueChange={handleTaskChange}>
                  <SelectTrigger className="h-11">
