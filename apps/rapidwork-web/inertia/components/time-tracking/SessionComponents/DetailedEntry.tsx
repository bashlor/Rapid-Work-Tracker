...
import WorkSessionEntry from '../SharedComponents/WorkSessionEntry'

const DetailedEntry = () => {
  const { createEmptySession, isLoading, sessions, setHasUnsavedChanges, setSessions } =
    useWorkSession()
    ...
    <div className="space-y-8">
      ...
      {!isLoading && sessions.length === 0 && (
        <div className="text-center p-10 border border-dashed border-slate-300 rounded-lg bg-slate-50">
          ...
          <div className="mt-4">
            <Button onClick={handleAddSession} size="lg" variant="outline">
      ...
      {!isLoading && (
        <div className="flex gap-4 pt-6">
          <Button className="w-auto" onClick={handleAddSession} size="lg" variant="outline">
            <Plus className="mr-2 h-5 w-5" />
            Ajouter une session
          </Button>

          <Button className="w-auto" onClick={handleResetAll} size="lg" variant="outline">
